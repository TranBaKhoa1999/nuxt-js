    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4">
        <div class="w-full max-w-md space-y-8 rounded-xl bg-white p-8 shadow-lg dark:bg-gray-800">
            ...
            <p class="text-center text-sm text-gray-500 dark:text-gray-400">
                ...
                <NuxtLink to="/register" class="font-semibold text-blue-600 hover:underline dark:text-blue-400">
                    Create one
                </NuxtLink>
            </p>
        </div>
...
const { login, loading: authLoading, error: authErrorState, resetError } = useAuth({ redirectOnLogin: '/products' })
...
const handleLogin = async () => {
    try {
        ...
        // error state is handled inside useAuth
    }
}
</script>